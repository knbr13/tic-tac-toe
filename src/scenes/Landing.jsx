...
const Landing = ({ setSelectedPage }) => {
  ...
  return (
    ...
    >
      {/* IMAGE SECTION */}
      <div className="basis-3/5 z-10 mt-8 md:mt-16 flex justify-center md:order-2">
        {isAboveLarge ? (
          <div
            className="relative z-0 ml-20 before:absolute before:-top-4 before:-left-4 rounded-lg 
      ...
      <div className="z-30 basis-2/5 mt-12 md:mt-32">
        ...
        >
          <p className="text-5xl font-playfair z-10 text-center md:text-start">
            Abdullah {""}
            <span
              className="xs:relative text-5xl xs:text-deep-blue xs:font-semibold z-20 xs:before:content-brush
